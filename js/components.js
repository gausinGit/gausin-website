...
const SECONDARY_MEGA_MENUS = [
  {
    ...
    items: [
      { href: 'services.html', icon: 'fa-drafting-compass', title: 'Process Design', desc: 'Simulation, P&ID, Equipment Sizing' },
      { href: 'services.html', icon: 'fa-ruler-combined', title: 'Detailed Engineering', desc: '3D CAD, Piping, Instrumentation' },
      { href: 'services.html', icon: 'fa-project-diagram', title: 'Turnkey Execution', desc: 'Planning, Commissioning, Handover' },
      { href: 'services.html', icon: 'fa-bolt', title: 'Energy Optimization', desc: 'MVR, Heat Recovery, Audits' },
      { href: 'services.html', icon: 'fa-robot', title: 'Automation & Control', desc: 'PLC/SCADA, IoT Integration' },
      { href: 'services.html', icon: 'fa-headset', title: 'Technical Consultancy', desc: 'Troubleshooting, De-bottlenecking' },
    ],
  },
  {
    ...
    items: [
      ...
      { href: 'industries.html', icon: 'fa-flask-vial', title: 'Chemical Industry', desc: 'Process plants, reactors' },
      { href: 'industries.html', icon: 'fa-utensils', title: 'Food Processing', desc: 'Hygienic plant solutions' },
  ...
  },
  {
    ...
    items: [
      { href: 'technology.html', icon: 'fa-atom', title: 'Process Simulation', desc: 'CHEMCAD, Mass & Energy Balance' },
      { href: 'technology.html', icon: 'fa-fire-flame-curved', title: 'Thermal Design', desc: 'HTRI Xchanger Suite' },
      { href: 'technology.html', icon: 'fa-pen-ruler', title: 'CAD & 3D Design', desc: 'AutoCAD, P&IDs, Plant Layout' },
      { href: 'technology.html', icon: 'fa-industry', title: 'Fabrication Technology', desc: 'CNC, TIG/MIG Welding, NDT' },
      { href: 'technology.html', icon: 'fa-sliders', title: 'PLC/SCADA Automation', desc: 'Control panels, HMI systems' },
      { href: 'technology.html', icon: 'fa-satellite-dish', title: 'IoT & Remote Monitoring', desc: 'Cloud analytics, diagnostics' },
    ],
  },
  {
    ...
    <div class="footer-top">
      ...
      <div>
        ...
        <div class="footer-contact-item">
          ...
          <div class="footer-contact-text"><a href="mailto:info@gausin.in" style="color:inherit;transition:color 0.2s;" onmouseover="this.style.color='var(--blue-400)'" onmouseout="this.style.color='inherit'">info@gausin.in</a></div>
        </div>
        <div class="footer-contact-item">
